...
#ifndef __OpcUaModbusGateway_OpcUaModbusServerGroup_h__
#define __OpcUaModbusGateway_OpcUaModbusServerGroup_h__
...
namespace OpcUaModbusGateway
{
	...
	class OpcUaModbusServerGroup
	{
	  public:
		using SPtr = std::shared_ptr<OpcUaModbusServerGroup>;
		using Vec = std::vector<SPtr>;

		OpcUaModbusServerGroup(void);
		~OpcUaModbusServerGroup(void);
